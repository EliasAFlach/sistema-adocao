# sistema-adocao
This project was developed as part of the Interactive Application Development with React course in the Postgraduate Program in Back-end Java Development (MIT InfNet).
...
local-api: http://localhost:4000/animals
